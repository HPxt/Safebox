  ...
  return (
    <button
      ...
      className="relative inline-flex items-center justify-center w-10 h-10 rounded-full 
                 bg-gray-200 dark:bg-dark-200 hover:bg-gray-300 dark:hover:bg-dark-300
                 transition-all duration-300 ease-in-out transform hover:scale-105
                 focus:outline-none focus:ring-2 focus:ring-safebox-500 focus:ring-offset-2
    ...
    >
      ...
      <div className="absolute inset-0 rounded-full bg-gradient-to-r from-transparent via-white/20 to-transparent 
                      ...
                      transition-transform duration-1000 ease-in-out opacity-0 hover:opacity-100" />
    </button>
  )
}
