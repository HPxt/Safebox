...
const Login: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 to-gray-100 px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-safebox-500">
            <Shield className="h-8 w-8 text-white" />
          </div>
          <h2 className="mt-6 text-3xl font-bold text-gray-900">SafeBox</h2>
          <p className="mt-2 text-sm text-gray-600">Entre na sua conta para acessar suas credenciais</p>
        </div>
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-8 shadow-lg">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            {success && (
              <div className="flex items-center rounded-lg border border-green-200 bg-green-50 px-4 py-3 text-green-700">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 pl-10 text-gray-900 shadow-sm placeholder-gray-400 focus:border-safebox-500 focus:outline-none focus:ring-2 focus:ring-safebox-500 sm:text-sm"
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 pl-10 pr-10 text-gray-900 shadow-sm placeholder-gray-400 focus:border-safebox-500 focus:outline-none focus:ring-2 focus:ring-safebox-500 sm:text-sm"
